...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Cosmic AI — Mapa Astral, Numerologia e IA Espiritual" },
      ...
      { name: "twitter:title", content: "Cosmic AI — Mapa Astral, Numerologia e IA Espiritual" },
